...
from migrations.chat_view_0_3_delete_gsiK1 import Migration
...
def chat_view(dynamo_table):
    ...
    item = {
        ...
        'gsiA1PartitionKey': f'chatView/{chat_id}',
        'gsiA1SortKey': first_viewed_at_str,
        'gsiA2PartitionKey': f'chatView/{user_id}',
        'gsiA2SortKey': first_viewed_at_str,
...
def test_migrate_one(dynamo_client, dynamo_table, caplog, chat_view):
    ...
    assert {
        **new_item,
        'gsiK1PartitionKey': item['gsiK1PartitionKey'],
        'gsiK1SortKey': item['gsiK1SortKey'],
    } == item
